...
#   Elastic Import   #
######################
#Use this function when you try to return empty indices
#You will see the following error message after trying to use the original 'Elastic import.R' script: 

# Error in (function (..., row.names = NULL, check.rows = FALSE, check.names = TRUE,  : 
#arguments imply differing number of rows: 1, 0Error in (function (..., row.names = NULL, check.rows = FALSE, check.names = TRUE,  : 
